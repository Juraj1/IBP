...
\projectinfo{
  ...
  supervisor.surname={Maršík},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
...
\abstract[cs]{V~této bakalářské práci se~autor zabývá návrhem radarového výškoměru. Čtenář je nejdříve uveden do~historického kontextu vývoje avioniky, fyzikálních objevů vedoucím k~měření výšky, stejně jako~je uveden do problematiky měření výšky. Dále jsou čtenáři ukázány použité technologie a~je mu přiblížena problematika přistání. Po~teoretickém úvodu se~autor věnuje návrhu jednotlivých částí zařízení, komunikaci mezi jednotlivými programy, komunikaci s~uživatelem a~umístění na~letadle. Po návrhu zařízení autor popisuje implementaci, kde~si zvolí implementační jazyk a~ukáže jednotlivé kroky implementace včetně testování. V~závěru je tato práce zhodnocena z~pohledu autora a~je rozvedeno její možné pokračování.}
\abstract[en]{In this bachelor thesis author designs a~radar altimeter. Firstly, the~reader is introduced to historical context of~avionics development, discoveries in the~field of physics leading to the~measuring of altitude as~well~as altitude measurement problematic. Secondly, the~used technologies are shown to the~reader and the~reader becomes acquainted with theory of~landing. After this theoretical beginning, author explains design of~each particular segment of~the~device, inter-program communication, communication with the~user and device-placement on the~aircraft. After designing the device, author describes implementation where he chooses the~language for implementation and shows steps that lead to~finished product including testing. In the~end of this thesis, the~work is evaluated from the author's point of view and~it's possible extensions are analyzed.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{radar, výškoměr, PulseAudio, C++, vícevláknové zpracování, BSD schránky, avionika, generování zvuku, vestavěné systémy, Zynq, FPGA, USB zvuková karta, přistání}
...
Další informace mi poskytli kolegové v~práci a~firma ARTISYS~s.r.o.
...
\acknowledgment{Tímto chci poděkovat mému vedoucímu, panu Ing.~Lukáši Maršíkovi za odborné vedení práce a~firmě ARTISYS~s.r.o. za poskytnutí vzdělání v oboru civilní letectví.}
